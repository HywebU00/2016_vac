 ...
 *
 * CUSTOMIZATIONS:
 * 1. Added aria-labels for WCAG compliance.
 * 2. Set "auto" to true by default.
 * 3. 【新增】整合了 customPausePlay 按鈕功能，可透過選項啟用。
 */
!(function (t) {
  var e = {},
    s = {
      ...
      nextText: 'Next',
      prevText: 'Prev',
      nextElAriaLabel: '下一張投影片',
      prevElAriaLabel: '上一張投影片',
      pagerElAriaLabel: '跳至投影片',
      nextSelector: null,
      prevSelector: null,
      autoControls: !1,
      startText: 'Start',
      ...
      autoDelay: 0,
      // 【新增】暫停/播放按鈕的設定
      customPausePlay: true, // 預設關閉此功能
      pausePlayOnTop: true, // 將按鈕移到最前面
      captions: true,
      pauseText: '暫停',
      playText: '播放',
      pauseElAriaLabel: '暫停輪播',
      playElAriaLabel: '播放輪播',
      // 【新增結束】
      minSlides: 1,
      maxSlides: 1,
      moveSlides: 0,
  ...
  t.fn.bxSlider = function (n) {
    ...
    var a = t(window).width(),
      ...
      d = function () {
        (o.settings = t.extend({}, s, n)),
          // 【新增】如果啟用自訂播放/暫停按鈕，則強制關閉 autoHover 以避免衝突
          o.settings.customPausePlay && (o.settings.autoHover = !1),
          // 【新增結束】
      ...
      c = function () {
        r.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'),
          ...
          o.settings.pager || o.settings.customPausePlay || o.viewport.parent().css({ margin: '0 auto 0px' }), // 調整
      ...
      w = function () {
        for (var e = '', i = x(), s = 0; i > s; s++) {
          var n = '';
          var ariaLabel = o.settings.pagerElAriaLabel + ' ' + (s + 1);
          o.settings.buildPager && t.isFunction(o.settings.buildPager) ? ((n = o.settings.buildPager(s)), o.pagerEl.addClass('bx-custom-pager')) : ((n = s + 1), o.pagerEl.addClass('bx-default-pager')),
            (e += '<div class="bx-pager-item"><a href="" data-slide-index="' + s + '" class="bx-pager-link" aria-label="' + ariaLabel + '" title="' + ariaLabel + '">' + n + '</a></div>');
        }
        o.pagerEl.html(e);
      },
      T = function () {
      ...
      C = function () {
        (o.controls.next = t('<a class="bx-next" href="">' + o.settings.nextText + '</a>').attr({
          'aria-label': o.settings.nextElAriaLabel,
          title: o.settings.nextElAriaLabel,
        })),
          (o.controls.prev = t('<a class="bx-prev" href="">' + o.settings.prevText + '</a>').attr({
            'aria-label': o.settings.prevElAriaLabel,
            title: o.settings.prevElAriaLabel,
          })),
      ...
      // 【新增】建立底部控制項的函式 (包含 Pager 和 Pause/Play)
      G = function () {
        if (o.settings.pager || o.settings.customPausePlay) {
          var e = t('<div class="bx-controls-bottom"></div>');
          if (o.settings.pager) {
            var i = t('<div class="bx-pager-container"></div>');
            (o.settings.pagerSelector = i), e.append(i), T();
          }
          if (o.settings.customPausePlay) {
            var s = t('<button type="button" class="bx-pause-play">' + o.settings.pauseText + '</button>');
            s.on('click', K).on('keydown', function (e) {
              'Enter' === e.key && (e.preventDefault(), K());
            }),
              (o.controls.pausePlayEl = s),
              e.append(s);
          }
          o.controls.el.append(e);
        }
      },
      // 【新增】更新 Pause/Play 按鈕狀態的函式
      U = function () {
        if (o.settings.customPausePlay && o.controls.pausePlayEl) {
          o.isPlaying ? o.controls.pausePlayEl.text(o.settings.pauseText).attr({ 'aria-label': o.settings.pauseElAriaLabel, 'aria-pressed': 'false' }) : o.controls.pausePlayEl.text(o.settings.playText).attr({ 'aria-label': o.settings.playElAriaLabel, 'aria-pressed': 'true' });
        }
      },
      // 【新增】自訂 Pause/Play 按鈕的點擊處理函式
      K = function () {
        o.isPlaying ? r.stopAuto() : r.startAuto();
      },
      P = function () {
    ...
    return (
      ...
      // 【調整】修改 startAuto 和 stopAuto 以更新按鈕狀態
